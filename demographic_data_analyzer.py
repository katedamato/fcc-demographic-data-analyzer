...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = round(df[df['education'] == 'Bachelors'].mean() * 100,1)
    ...
    rich_country_percentage = (rich_country_counts / country_counts * 100).fillna(0)
    ...
    india_rich = df[(df['native-country'] == 'India') & (df['salary'] == '>50K')]  #dataframe of all the salaries about 50k in India
